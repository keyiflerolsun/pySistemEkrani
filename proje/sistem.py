...
net_io = psutil.net_io_counters()
gonderilenByte = birimDonusturucu(net_io.bytes_sent)
alinanByte = birimDonusturucu(net_io.bytes_recv)

disk_io = psutil.disk_io_counters()
okunanByte = birimDonusturucu(disk_io.read_bytes)
yazilanByte = birimDonusturucu(disk_io.write_bytes)

svmem = psutil.virtual_memory()
bellekBilgisi = birimDonusturucu(svmem.total)